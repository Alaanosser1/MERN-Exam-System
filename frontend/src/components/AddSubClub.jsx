    ...
    <>
      <div dir="rtl" className="container">
        ...
        <form onSubmit={handleSubmit(formSubmit)}>
          ...
          <div className="row">
            <div className="col-6">
              <h5 className="mt-4">العام الدراسي</h5>
              <select
                {...register("studyingYearRequired", { required: true })}
                onChange={(e) => {
                  e.preventDefault();
                  setStudyingYear(e.target.value);
                }}
                id="inputState"
                className="form-control"
              >
              ...
              {errors.studyingYearRequired && (
                <span className="text-danger">
                  من فضلك اختر فئة العام الدراسي*
                </span>
              )}
            </div>
          </div>
