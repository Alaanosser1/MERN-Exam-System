              ...
              return (
                <tr scope="row" key={club[1].sub_club_id}>
                  ...
                  {JSON.parse(localStorage.getItem("instructor-token")) && (
                    <td className="text-center">
                      <Link
                        to={`/app/mainClubReports/${mainClubId}/${club[1].sub_club_id}`}
                      >
                  ...
                  {JSON.parse(localStorage.getItem("data-entry-token")) && (
                    <td className="text-center">
                      <Link
                        to={`/clubs/mainClubReports/${mainClubId}/${club[1].sub_club_id}`}
                      >
                        <button className="btn btn-outline-primary">
                          عرض التقارير
                        </button>
                  ...
                  {JSON.parse(localStorage.getItem("admin-token")) && (
                    <td className="text-center">
                      <Link
                        to={`/admin/mainClubReports/${mainClubId}/${club[1].sub_club_id}`}
                      >
                        <button className="btn btn-outline-primary">
                          عرض التقارير
                        </button>
...
export default SubClubsReports;
