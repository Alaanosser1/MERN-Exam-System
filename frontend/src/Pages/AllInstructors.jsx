...
import AddExaminee from "../Pages/DataEntry/AddInstructor";
import StudentSearch from "../Pages/DataEntry/StudentsSearch";
    ...
    <>
      ...
      <div className="container list-container mt-5">
        <div className="row" dir="rtl">
          <div className="col-9">
            <h1 className="mt-5">المحاضرين</h1>
          </div>
          <div className="col-3">
            <button
              onClick={() => {
      ...
      <div dir="rtl" className="row">
        <h2>عدد المحاضرين: {searchResults.length}</h2>
      </div>
    </>
  );
};
